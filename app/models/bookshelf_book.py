...
class BookshelfBook(db.Model):
    ...
    # Relationships
    bookshelf = db.relationship('Bookshelf', backref='bookshelf_books', cascade="all, delete-orphan")
    book = db.relationship('Book', backref='bookshelves_books', cascade="all, delete-orphan")
